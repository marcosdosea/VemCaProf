    ...
    public class DisciplinaServiceTests
    {
        ...
        public void Initialize()
        {
            ...
            var disciplinas = new List<Disciplina>
                {
                    new() { Id = 1, Nome = "Matem�tica" },
                    new() { Id = 2, Nome = "Portugu�s" },
                    new() { Id = 3, Nome = "Hist�ria" },
                };
        ...
        public void GetTest()
        {
            ...
            // Assert
            Assert.IsNotNull(disciplina);
            Assert.AreEqual("Matem�tica", disciplina.Nome);
        }
        ...
        public void GetAllTest()
        {
            ...
            Assert.AreEqual("Matem�tica", listaDisciplina.First().Nome);
        }
        ...
        public void GetByNomeTest()
        {
            ...
            Assert.AreEqual("Matem�tica", disciplinas.First().Nome);
        }
    }
}